...
Definition fprop {E : Events} {Es: EndState} :=
  @finpref E Es -> Prop.
...
Lemma safety_safety'  {E : Events} {Es : EndState} :
...
Inductive Observations  {E : Events} {Es : EndState} : (@finpref E Es -> Prop) -> Prop :=
...
Definition Cl  {E : Events} {Es : EndState}
               (π : prop (@trace E Es)) : prop (@trace E Es) :=
  fun t => forall S, Safety S -> π ⊆ S -> S t.   

Lemma Cl_bigger  {E : Events} {Es : EndState}
                 (π: prop (@trace E Es)) : π ⊆ (Cl π). 
Proof. firstorder. Qed. 

Lemma Cl_Safety {E : Events} {Es : EndState}
...
Lemma Cl_id_on_Safe {E : Events} {Es : EndState}
                    (π: prop (@trace E Es)) :
  Safety π -> Cl π = π.
Proof.
...
Lemma Cl_smallest {E : Events} {Es : EndState}
                  (π: prop (@trace E Es)) :
    forall S, Safety S -> π ⊆ S -> Cl π ⊆ S.
Proof. by firstorder. Qed.

Lemma Cl_mono {E : Events} {Es : EndState} : monotone (@Cl E Es).
Proof. 
...
Lemma Cl_idmp {E : Events} {Es : EndState} : idempotent (@Cl E Es). 
Proof. move => π. apply: Cl_id_on_Safe. apply: Cl_Safety. Qed.


Definition safety_uco {E : Events} {Es : EndState} := Build_Uco (@Cl_mono E Es)
                                                                (@Cl_idmp E Es)
                                                                (@Cl_bigger E Es).


Lemma Safety_Cl_prop {E : Events} {Es : EndState} :
...
Definition Dense {E : Events} {Es : EndState}
                 (π: prop (@trace E Es)) : Prop :=
  forall t, finite t -> π t.

Definition dCl {E : Events} {Es : EndState} : prop (@trace E Es) -> prop (@trace E Es) :=
  fun π => (fun t => finite t \/ π t).

Lemma Dense_dCl {E : Events} {Es : EndState} 
                  (π: prop (@trace E Es)) : Dense (dCl π).
Proof. firstorder. Qed.

Lemma dCl_mono {E : Events} {Es : EndState} :
  monotone (@dCl E Es).
Proof.
...
Lemma dCl_idmp {E : Events} {Es : EndState} :
  idempotent (@dCl E Es).
Proof.
  rewrite /dCl => π.
...
Lemma dCl_ext {E : Events} {Es : EndState} :
  extensive (@dCl E Es).
Proof.  
  rewrite /dCl => π t π_t. by right.
Qed.

Lemma dCl_id_on_Dense {E : Events} {Es : EndState}
                      (π: prop (@trace E Es)):
  Dense π -> dCl π = π.
Proof.
...
Definition dense_uco {E : Events} {Es : EndState} :=
  Build_Uco (@dCl_mono E Es)
            dCl_idmp
            dCl_ext.

Lemma Dense_Cl_prop {E : Events} {Es : EndState} :
...
Definition HSafe {E : Events} {Es : EndState}
                 (H: hprop (@trace E Es)) :=
...
Definition hsCl {E : Events} {Es : EndState}
                 (H: hprop (@trace E Es)) : (hprop (@trace E Es)) :=
  fun b => forall Hs, HSafe Hs -> H ⊆ Hs -> Hs b. 

Lemma hsCl_bigger {E : Events} {Es : EndState}
                  (H: hprop (@trace E Es)) :  H ⊆ hsCl H.
Proof. by firstorder. Qed. 

Lemma hsCl_HSafe {E : Events} {Es : EndState}
...
Lemma HSafe_SCH {E : Events} {Es : EndState} :
...
Lemma sCl_id_on_HSafe {E : Events} {Es : EndState} :
...
Lemma hsCl_sCl {E : Events} {Es : EndState} :
...
Lemma hsCl_smallest {E : Events} {Es : EndState}
                    (H: hprop (@trace E Es)):
