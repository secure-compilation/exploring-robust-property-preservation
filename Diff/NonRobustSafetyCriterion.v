...
Require Import NonRobustSafetyDef.
...
Section SafetyCriterion.
  ...
  Variable T_events S_events : Events.
  Variable T_end S_end : EndState. 

  Local Definition trace__S := @trace S_events S_end.
  Local Definition finpref__S := @finpref S_events S_end. 
  Local Definition trace__T := @trace T_events T_end.
  Local Definition finpref__T := @finpref T_events T_end. 
  
  Local Definition prop__S := prop trace__S.
  Local Definition Safety__S := @Safety S_events S_end. 
  Local Definition prop__T := prop trace__T.
  Local Definition Safety__T := @Safety T_events T_end. 
